    ...
    <Grid className="landing-page-content">
      <Row>
        <Col lg={12} md={12} sm={12}>
          <h1> Praisinator</h1>
          <p> What's the mood of your team today? Not sure? Well, now you don't have to
          fret, worry, or pour over thousands of messages searching for a clue.
          With the help of state-of-the-art technology you, <strong>yes you</strong>, can easily identify the
          mood of your Slack teams and channels. No more sleepless nights wondering what your
          team is feeling. Are they happy, sad, angry, fearful...? With Praisinator, you
          have the answer.
           </p>
           <ButtonToolbar>
      ...
      <Col md={4} sm={4}>
          ...
          We're there through all the conversation's ups and downs. </p>
      </Col>
      <Col md={4} sm={4}>
          <div className="slack-logo">
          ...
          <p> There's a lot of chatter and emotions that occur throughout the day.
              ...
              Now you can get a sense of your team's mood without all the wonder or worry. </p>
      </Col>
      <Col md={4} sm={4}>
        <div className="slack-logo">
